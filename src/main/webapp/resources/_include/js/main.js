...
BRUSHED.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'static/resources/_include/img/slider-images/image01.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''},
											{image : 'static/resources/_include/img/slider-images/image02.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''},
											{image : 'static/resources/_include/img/slider-images/image03.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''},
											{image : 'static/resources/_include/img/slider-images/image04.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''}  
									],
...
BRUSHED.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          modpath: 'static/resources/_include/js/twitter/',
...
$(document).ready(function(){
	Modernizr.load([
	{
		...
		nope: 'static/resources/_include/js/placeholder.js', 
		complete : function() {
