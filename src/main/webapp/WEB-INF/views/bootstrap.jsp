...
<div class="container">
    ...
    <div class="row table-responsive">
	    <div align="center">
	    <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#adminBetModal">
		  Ver apuesta de la semana
		</button>
		<!-- Modal -->
		<div class="modal fade" id="adminBetModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
