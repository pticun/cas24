function SiteMembers (collectionId, baseUrl, smVarOnWindow, metaSiteId) {
    ...
    return {
        ...
        login: function (email, password, rememberMe, onSuccess, onError) {
        ...
        apply: function (email, password, onSuccess, onError) {
        ...
        inActivate: function (memberId, onSuccess, onError) {
            _sendAction("inActivate", [memberId], onSuccess, onError);
        },

        activate: function (memberId, onSuccess, onError) {
